<template>
  <div class="MedicalStaff_Box">
    <div class="close"
         @click="closePanel"></div>
    <div class="MedicalStaff_Box_top">
      <span>Medical Staff</span>
    </div>
    <div class="MedicalStaff_Box_Bottom">
      <div>
        <span>Name</span>
        <span>{{ data.Name }}</span>
      </div>
      ...
      <div>
        <span>Belonging Unit</span>
        <span>{{ data.Belonging }}</span>
      </div>
      <div>
...
.MedicalStaff_Box {
  width: 590px;
  height: 310px;
  background: url("../../../assets/img/popupIMG/fiveBJ.png") no-repeat;
