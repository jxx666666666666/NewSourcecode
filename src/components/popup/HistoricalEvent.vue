<template>
  <div class="HistoricalEvent_Box">
    <div class="close"
         @click="closePanel"></div>
    <div class="HistoricalEvent_Box_top">
      <span>Historical Event</span>
    </div>
    <div class="HistoricalEvent_Box_Bottom">
      <div>
...
.HistoricalEvent_Box {
  width: 515px;
  height: 400px;
  background: url("../../assets/img/popupIMG/HistoricalEventBJ.png") no-repeat;
