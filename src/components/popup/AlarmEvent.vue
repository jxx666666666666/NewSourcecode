<template>
  <div class="AlarmEvent_Box">
    <div class="close"
         @click="closePanel"></div>
    <div class="AlarmEvent_Box_top">
      <span>Alarm Event</span>
    </div>
    <div class="AlarmEvent_Box_Bottom">
      <div>
...
.AlarmEvent_Box {
  width: 560px;
  height: 310px;
  background: url("../../assets/img/popupIMG/AlarmEventBJ.png") no-repeat;
